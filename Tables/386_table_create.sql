...
Create Table SoftwareE_Review(
	...
	About_User_ID number(5) Constraint User_FName_NN Not Null DEFERRABLE INITIALLY IMMEDIATE,
	From_User_ID number(5) Constraint User_FName_NN Not Null DEFERRABLE INITIALLY IMMEDIATE,
);
