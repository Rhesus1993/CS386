...
<?php
	...
	$query = "SELECT `User_FName`, `User_LName`, `Review_ID` FROM `review` INNER JOIN `user` on `user`.User_Id = `review`.About_User_ID WHERE `From_User_ID` = '".$_SESSION['login']."' AND `Review_Flag` = '2'";
